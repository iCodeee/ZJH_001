...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/iCodeee/ZJH_001"
  ...
  s.source       = { :git => "https://github.com/iCodeee/ZJH_001.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ZJH_001/ZJH_001/**/*.{h,m,swift}"
